  ...
  create  table "FriscoVoter"."friscovoterid_stage"."FriscoVoterElectionsPivot__dbt_tmp"
  as (
    

with FriscoVoterElections as (
select * from "FriscoVoter"."friscovoterid_stage"."FriscoVoterElections"
)
...
select
  *
from final as f
left join FriscoVoterInformation using (sosvoterid)
limit 10
  );